...
| 14  | [Decoradores y Validación](./modulo-14-decoradores.md)            | `@functools.wraps`, RBAC, Pydantic spec-driven                  | `modulo-14-decoradores.md`            |
| 15  | [Documentación y Testing](./modulo-15-testing.md)                 | `doctest`, `unittest`, pre-commit, `bandit`, `safety`           | `modulo-15-testing.md`                |
