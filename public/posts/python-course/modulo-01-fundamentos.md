...
| **Credenciales hardcoded**       | `MY_SECRET_VALUE = "tok_live_xxx"` (Ejemplo de riesgo)                | Usar `python-dotenv`; secrets en gestor (Vault/AWS SSM); nunca `git add .env`               | NIST SC-8 · ENS [mp.info.3] |
