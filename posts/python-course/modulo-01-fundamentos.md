...
| **Credenciales hardcoded**       | `API_KEY = "[REDACTED_API_KEY]"` en el código fuente                  | Usar `python-dotenv`; secrets en gestor (Vault/AWS SSM); nunca `git add .env`               | NIST SC-8 · ENS [mp.info.3] |
