...
| **Secretos en el código**                  | `API_KEY = "[REDACTED_API_KEY]"` hardcodeado en el código fuente           | `detect-private-key` en pre-commit; `python-dotenv` + `.env` en `.gitignore`     | CWE-798 · NIST IA-5       |
